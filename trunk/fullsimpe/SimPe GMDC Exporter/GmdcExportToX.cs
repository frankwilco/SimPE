...
namespace SimPe.Plugin.Gmdc
{
	...
	public class GmdcExportToX : AbstractGmdcExporter
	{
		...
		{
			if (modelnames==null) modelnames=new System.Collections.ArrayList();
		...
		{			
			...
			for (int i = 0; i < VertexElement.Values.Length; i++)
			{
				...
				writer.Write(
					VertexElement.Values[i].Data[0].ToString("N9", CultureInfo.InvariantCulture) + ";"+
					VertexElement.Values[i].Data[1].ToString("N9", CultureInfo.InvariantCulture) + ";"+
					VertexElement.Values[i].Data[2].ToString("N9", CultureInfo.InvariantCulture) + "; "
					);
			}
			writer.WriteLine(";");
			...
			{				
				...
				for (int i = 0; i < NormalElement.Values.Length; i++)
				{
					...
					if (i!=0) writer.WriteLine(",");
					writer.Write(
						NormalElement.Values[i].Data[0].ToString("N9", CultureInfo.InvariantCulture) + ";"+
						NormalElement.Values[i].Data[1].ToString("N9", CultureInfo.InvariantCulture) + ";"+
						NormalElement.Values[i].Data[2].ToString("N9", CultureInfo.InvariantCulture) + ";"
						);
				}
				writer.WriteLine(";");
				writer.WriteLine(faces);
			...
			{								
				...
				{
					writer.WriteLine(
						UVCoordinateElement.Values[i].Data[0].ToString("N9", CultureInfo.InvariantCulture) + ";"+
						UVCoordinateElement.Values[i].Data[1].ToString("N9", CultureInfo.InvariantCulture) + ";"
						);
				}
				writer.WriteLine(";");
				writer.WriteLine("}"); 
