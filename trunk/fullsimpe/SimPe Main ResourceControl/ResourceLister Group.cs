...
{
	/// <summary>
	/// List the Resources available in a Package by Group
	/// </summary>
	public class GroupResourceLister : ResourceListerBase
	{
		public GroupResourceLister(LoadedPackage pkg, ViewFilter filter) :base (pkg, filter) {}
