[Constants]
#define FriendlyVersion "{shortver} (alpha, light)"
...
Source: Plugins\bidou.career.plugin.dll; DestDir: {app}\Plugins; Flags: overwritereadonly ignoreversion; Components: ThirdParty\CareerEditor; Tasks: ; Languages: 
