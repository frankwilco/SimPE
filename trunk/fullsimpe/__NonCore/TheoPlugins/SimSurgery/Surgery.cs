...
namespace SimPe.Plugin
{
	...
	public class Surgery : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// ctlLoadPackage
			// 
			this.ctlLoadPackage.AccessibleDescription = resources.GetString("ctlLoadPackage.AccessibleDescription");
			this.ctlLoadPackage.AccessibleName = resources.GetString("ctlLoadPackage.AccessibleName");
			this.ctlLoadPackage.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("ctlLoadPackage.Anchor")));
			this.ctlLoadPackage.AutoSize = ((bool)(resources.GetObject("ctlLoadPackage.AutoSize")));
			this.ctlLoadPackage.Dock = ((System.Windows.Forms.DockStyle)(resources.GetObject("ctlLoadPackage.Dock")));
			this.ctlLoadPackage.Enabled = ((bool)(resources.GetObject("ctlLoadPackage.Enabled")));
			this.ctlLoadPackage.Font = ((System.Drawing.Font)(resources.GetObject("ctlLoadPackage.Font")));
			this.ctlLoadPackage.Image = ((System.Drawing.Image)(resources.GetObject("ctlLoadPackage.Image")));
			this.ctlLoadPackage.ImageAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("ctlLoadPackage.ImageAlign")));
			this.ctlLoadPackage.ImageIndex = ((int)(resources.GetObject("ctlLoadPackage.ImageIndex")));
			this.ctlLoadPackage.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("ctlLoadPackage.ImeMode")));
			this.ctlLoadPackage.LinkArea = ((System.Windows.Forms.LinkArea)(resources.GetObject("ctlLoadPackage.LinkArea")));
			this.ctlLoadPackage.Location = ((System.Drawing.Point)(resources.GetObject("ctlLoadPackage.Location")));
			this.ctlLoadPackage.Name = "ctlLoadPackage";
			this.ctlLoadPackage.RightToLeft = ((System.Windows.Forms.RightToLeft)(resources.GetObject("ctlLoadPackage.RightToLeft")));
			this.ctlLoadPackage.Size = ((System.Drawing.Size)(resources.GetObject("ctlLoadPackage.Size")));
			this.ctlLoadPackage.TabIndex = ((int)(resources.GetObject("ctlLoadPackage.TabIndex")));
			this.ctlLoadPackage.TabStop = true;
			this.ctlLoadPackage.Text = resources.GetString("ctlLoadPackage.Text");
			this.ctlLoadPackage.TextAlign = ((System.Drawing.ContentAlignment)(resources.GetObject("ctlLoadPackage.TextAlign")));
			this.toolTip1.SetToolTip(this.ctlLoadPackage, resources.GetString("ctlLoadPackage.ToolTip"));
			this.ctlLoadPackage.Visible = ((bool)(resources.GetObject("ctlLoadPackage.Visible")));
			...
			this.opd.Filter = resources.GetString("opd.Filter");
			this.opd.Title = resources.GetString("opd.Title");
		...
		private void UsePatient(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			button1.Enabled = (pbpatient.Image!=null) && (pbarche.Image!=null || this.tarcheFile != null);
		...
		protected void FaceSurgery()
		{
			try 
			{
				...
				//TODO: This function also needs file type checking
		...
		private void Export(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			try 
			{
				...
				sfd.InitialDirectory = System.IO.Path.Combine(SimPe.PathProvider.SimSavegameFolder, "SavedSims");
		...
		bool CanDo()
		{
			...
			if (cbskin.Checked)
			{
				...
				if (ret) if (lv.Items[0].Selected && (sarche == null && tarcheFile == null)) ret=false;
		...
		private void opd_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
		{
			if (!e.Cancel)
			{
				...
				lbarchlife.Text = System.IO.Path.GetFileNameWithoutExtension(this.opd.FileName);

				//TODO: Further checking must be done here, i guess :þ

				//RATIONALE:
				/*
				* Indeed, one must check right away if the selected package
				* contains all the necessary files for the procedure.
				*
				* The required file types depend on the selection made
				* by the user (face/makeup/genetics). This has the drawback
				* of an extra burden of file checking when one of 
				* those settings change.
				*
				* The alternative is to make the check at the Open() function,
				* and to popup warnings when the selected package is invalid.
				* One could take advantage of the fact that the archetype file 
				* is read in this function anyway.
				* Update: see the CheckArchetypeFile() function
				*
				*/ 
		...
		bool CheckArchetypeFile(SimPe.Packages.File archeFile)
		{
			...
			//list.Add(0x856DDBACu); //IMG
			//list.Add(0x534C4F54u); //SLOT
