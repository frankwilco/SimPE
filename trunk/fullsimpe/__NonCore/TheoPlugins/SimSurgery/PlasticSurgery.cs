...
/*
			// this function will change the data in the archetype's file,
			// so that its contents can safely replace the patient's 3IDR resources
			if (this.fromTemplate)
				this.ProcessClothing(this.patient, this.archetype);
*/
