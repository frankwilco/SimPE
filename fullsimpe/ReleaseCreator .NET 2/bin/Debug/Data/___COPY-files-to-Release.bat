...
SET SRC={simpedir}
SET SRC2={simpedir}\LatestWorkingAppfiles
SET DST={simpedir}\AppFiles
...
XCOPY "%SRC%\Plugins\theos.simsurgery.plugin.plugin.dll" "%DST%\Non-Core\Theo-ClothingEditor\Plugins\" /C /I /R /Y
